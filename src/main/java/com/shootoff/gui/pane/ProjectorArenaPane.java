...
public class ProjectorArenaPane extends AnchorPane implements CalibrationListener, Closeable {
	...
	public void autoPlaceArena() {
		...
		// two screens,
		// put it on the screen the PhanMemBanSung window isn't on
	...
	private void showPerspectiveUsageMessage() {
		...
		final String message = "Did you know that PhanMemBanSung supports configuring targets to appear at real "
				+ "world distances? PhanMemBanSung supports this feature out of the box for some cameras, but "
