...
public class ProjectorTrainingExerciseBase extends TrainingExerciseBase {
	 ...
	 *            the resource path to the default PhanMemBanSung background to set.
	 * 
	 * @since 3.10
	 */
	...
	/**
	 * Determines whether or not PhanMemBanSung has sufficient information to set a
	 * target's distance to a real world distance.
	 * 
	 * @return <code>true</code> if PhanMemBanSung can set a target to a real world
	 *         distance
	 * 
	 * @since 3.8
	 */
	 ...
	 * this, you must already know the size of the target and PhanMemBanSung must be
	 ...
	 * @return <code>true</code> if PhanMemBanSung has the data to resize a target and
