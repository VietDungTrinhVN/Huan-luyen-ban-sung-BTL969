...
public abstract class TrainingExerciseBase {
	 ...
	 * settings) to the bottom of the main PhanMemBanSung window.
	 * 
	 * @param pane
	 *            a pane with exercise-specific controls to add to the main
	 *            PhanMemBanSung window
	 */
	 ...
	 *            is clicked
	 * 
	 * @return the new button that was added to the main PhanMemBanSung window
	 */
	 ...
	 * 
	 * @return a list of all targets that PhanMemBanSung will detect hits (only lists
